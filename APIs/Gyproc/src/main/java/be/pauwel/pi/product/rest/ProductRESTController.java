...
public class ProductRESTController {
    ...
    @RequestMapping(method = RequestMethod.GET, params = "propsIncluded", value = "/gyproc/ws/products")
    ...
    @RequestMapping(value = "/gyproc/ws/products", params = "id", method = GET)
    @ResponseBody
    Product getProductWithId(@RequestParam("id") String id) {
        return productService.getProductWithId(id);
    }

    @RequestMapping(value = "/gyproc/ws/products", method = RequestMethod.POST)
